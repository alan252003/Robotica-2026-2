...
# Cinematica para manipulador planar
class KinematicsManipulatorA():
  def __init__(self):
    pass
  def direct_kinematics(self):
    ...
    self.l2 = 0.45
    self.l3 = 0.45
    self.T_0_1 = self.trans_homo(0, 0, 0.15, 0, 0, self.theta_0_1)
  ...
  def ws_graph(self):
    ...
    fig.suptitle("Espacio de trabajo de robot RRR en el plano XY")
  ...
  def q_graph(self):
    ...
    fig, (p_g, v_g, a_g) = plt.subplots(nrows=1, ncols=3, figsize=(15, 4))
    fig.suptitle("Espacio de las juntas de robot RRR en el plano XY")
    
    p_g.set_title("Posiciones")
    p_g.plot(self.t_m.T, self.q_m[0, :].T, 'r-', linewidth=2)
    p_g.plot(self.t_m.T, self.q_m[1, :].T, 'g-', linewidth=2)
    p_g.plot(self.t_m.T, self.q_m[2, :].T, 'b-', linewidth=2)
    p_g.set_xlabel("Tiempo (s)")
    ...
    v_g.plot(self.t_m.T, self.q_dot_m[2, :].T, 'b-', linewidth=2)
    v_g.set_xlabel("Tiempo (s)")
    ...
    a_g.plot(self.t_m.T, self.q_dot_dot_m[2, :].T, 'b-', linewidth=2)
    a_g.set_xlabel("Tiempo (s)")
  ...
  def trans_homo_xy(self, x=0, y=0, theta=0)->Matrix:
    R_z = Matrix([
