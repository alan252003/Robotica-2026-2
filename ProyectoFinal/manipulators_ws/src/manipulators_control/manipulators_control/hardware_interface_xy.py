...
class HardwareInterfaceXY(Node):
  def __init__(self):
    super().__init__("hardware_interface_xy")
    ...
    self.current_joint_state.name = ["first_arm_circ1_joint", "second_arm_circ1_joint", "third_arm_circ1_joint"]
  ...
  def joint_states_timer_callback(self):
    ...
    msg.name = ["first_arm_circ1_joint", "second_arm_circ1_joint", "third_arm_circ1_joint"]
